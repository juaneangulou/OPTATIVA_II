...
Lo que construyas aquí será la base para la próxima conversación: modelado de dominios y límites de contexto.
...
Quiero que empecemos por la afirmación que trae la fuente: La experiencia del usuario es una consecuencia del diseño arquitectónico. Si la tomamos en serio, acoplamiento, cohesión y calidad estructural deja de ser una etiqueta y se convierte en una decisión que debemos observar en el sistema.
...
La alternativa A reduce el costo inicial y conserva simplicidad, pero puede dejar expuesto el riesgo principal de acoplamiento, cohesión y calidad estructural. La alternativa B ofrece una protección más explícita, pero agrega trabajo, dependencias o complejidad operativa. No conviene elegir B solo porque suena más moderna; debe responder a la evidencia del caso.
