...
Antes de entrar en acoplamiento, cohesión y calidad estructural, deténgase en el problema que lo hace necesario. En arquitectura no aprendemos una palabra para repetirla en un diagrama; aprendemos a reconocer una situación, analizar alternativas y tomar una decisión defendible.
...
Acoplamiento, cohesión y calidad estructural se entiende mejor cuando lo conectamos con esta secuencia: contexto, alternativas, decisión, consecuencias y evidencia. Si falta uno de esos pasos, la propuesta queda incompleta.

## Preguntas del profesor durante la explicación
- ¿Qué parte del problema pertenece realmente a acoplamiento, cohesión y calidad estructural?
...
## Errores frecuentes
- Confundir el nombre del tema con una explicación de cómo acoplamiento, cohesión y calidad estructural afecta el sistema.
