...
Al terminar esta conversación, tendrás una decisión nueva que enlaza con acoplamiento entre servicios y sistemas.

## 🧭 Navegar por la ruta
[⬅️ Video anterior: Microservicios y organización por dominios](video-13.md)

[➡️ Video siguiente: Acoplamiento entre servicios y sistemas](video-15.md)

## 🎥 La situación que vamos a resolver
La fuente consultada para esta clase es 'Video 13: APIs y contratos de integración'. En nuestro recorrido la conectamos con el tema 'APIs y contratos de integración' porque queremos estudiar apis y contratos de integración desde un problema real. La fuente plantea: Este video centra la atención en la forma en que los sistemas se integran entre sí. Las APIs son contratos entre partes: representan cómo se comunica un servicio con otro y cómo se comparte información. Cuando esos contratos son claros, la integración es más productiva y menos frágil. Cuando no lo son, se vuelven fuentes de errores, incompatibilidades y cambios difíciles de gestionar.

El diseño de APIs incluye no solo endpoints o rutas, sino también formato, validaciones, errores, versionado y políticas de evolución. Una buena API debe ser clara, estable y fácil de consumirse por el equipo o por sistemas externos. En la plataforma logística, esto aparece cuando pedidos, inventario, rutas y notificaciones deben colaborar sin compartir toda su lógica interna. Primero entenderemos la fuente y después construiremos la decisión.
...
- **Te pregunto:** ¿Mis interfaces están bien definidas y documentadas? **Lo que busco:** que relaciones la respuesta con una decisión observable del sistema.
...
- **Te pregunto:** ¿Estoy diseñando para compatibilidad o para cambios improvisados? **Lo que busco:** que relaciones la respuesta con una decisión observable del sistema.
...
## 🔀 Opciones para resolver apis y contratos de integración
...
Voy a tomar una situación del proyecto: pedidos, inventario, rutas y notificaciones deben colaborar sin compartir toda su lógica interna. La fuente afirma que Las APIs son acuerdos de comunicación entre sistemas.. Entonces la primera decisión no es comprar una herramienta; es decidir qué responsabilidad debe quedar explícita y qué información necesitamos observar.
...
La conclusión de la fuente es clara: El diseño de APIs es una parte central de la arquitectura. Un buen contrato de integración mejora la evolución del sistema y reduce errores de colaboración entre equipos. Mi pregunta para ti es: ¿qué parte de esa conclusión cambia la forma en que estás diseñando la plataforma?
...
1. Escribe qué significa apis y contratos de integración en tus propias palabras y relaciónalo con esta fuente: Este video centra la atención en la forma en que los sistemas se integran entre sí.
...
1. **¿Mis interfaces están bien definidas y documentadas?** Mi respuesta de partida es: Las APIs son acuerdos de comunicación entre sistemas. En el proyecto, esto se comprueba con una evidencia concreta y no solamente con una opinión.
2. **¿Qué pasa si un cliente usa una versión anterior?** Mi respuesta de partida es: Los contratos deben ser claros y bien documentados. En el proyecto, esto se comprueba con una evidencia concreta y no solamente con una opinión.
3. **¿Estoy diseñando para compatibilidad o para cambios improvisados?** Mi respuesta de partida es: El versionado reduce riesgos de romper dependencias. En el proyecto, esto se comprueba con una evidencia concreta y no solamente con una opinión.
...
La idea que debes llevarte no es “aprendí otro término”. Es esta: ahora puedes mirar apis y contratos de integración, relacionarlo con un problema real y defender una decisión sin esconder sus límites. Esa capacidad será necesaria cuando avancemos hacia acoplamiento entre servicios y sistemas.
