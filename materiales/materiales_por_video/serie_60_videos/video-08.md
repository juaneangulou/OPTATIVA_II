# Video 8: Riesgos y supuestos en diseño
...
Vienes de trabajar costos ocultos y deuda técnica. No vamos a repetirlo: lo usaremos como punto de partida para estudiar riesgos y supuestos en diseño y añadir una decisión nueva al expediente.

Lo que construyas aquí será la base para la próxima conversación: diagnóstico de contexto arquitectónico.
...
La idea central es que un sistema bien diseñado no solo funciona, sino que es más fácil de entender, mantener y evolucionar. Los principios de arquitectura sirven como brújula para tomar decisiones con criterio, especialmente cuando el proyecto crece en complejidad. El equipo te pide una decisión sobre riesgos y supuestos en diseño, pero todavía no existe una respuesta única. Tu primera pista es esta idea de la fuente: El diseño arquitectónico no es un detalle opcional.
...
## 🎬 Apertura: Riesgos y supuestos en diseño
Hoy vamos a trabajar una situación concreta: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.

La idea central es que un sistema bien diseñado no solo funciona, sino que es más fácil de entender, mantener y evolucionar. Los principios de arquitectura sirven como brújula para tomar decisiones con criterio, especialmente cuando el proyecto crece en complejidad. No quiero que empieces por un diagrama ni por una tecnología. Quiero que me expliques qué problema aparece aquí y por qué merece una decisión arquitectónica propia.

Antes de entrar en riesgos y supuestos en diseño, quiero que escuchemos primero la idea central de la fuente del curso: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.

La idea central es que un sistema bien diseñado no solo funciona, sino que es más fácil de entender, mantener y evolucionar. Los principios de arquitectura sirven como brújula para tomar decisiones con criterio, especialmente cuando el proyecto crece en complejidad. En arquitectura no aprendemos una palabra para repetirla en un diagrama; aprendemos a reconocer una situación, analizar alternativas y tomar una decisión defendible.

Imagina que estamos frente a una pizarra. Yo te miro y te pregunto: ¿qué está pasando en este caso?, ¿quién depende de que esto funcione?, ¿qué información nos falta? No me respondas todavía con nombres de herramientas. Primero cuéntame qué problema ves en riesgos y supuestos en diseño. Esa primera respuesta me permite saber si estamos entendiendo el tema o si solo estamos repitiendo soluciones conocidas.
...
## 💬 La pregunta que vamos a resolver sobre riesgos y supuestos en diseño
¿Qué problema real resuelve riesgos y supuestos en diseño y cómo demostraríamos que la solución es adecuada?

## 🧠 Entender riesgos y supuestos en diseño desde el caso
### 📚 Lo que la fuente nos enseña sobre riesgos y supuestos en diseño
La fuente describe este tema así: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.
...
Quiero que empecemos por la afirmación que trae la fuente: El diseño arquitectónico no es un detalle opcional. Si la tomamos en serio, riesgos y supuestos en diseño deja de ser una etiqueta y se convierte en una decisión que debemos observar en el sistema.

Ahora conectemos esa afirmación con la siguiente: Los principios ayudan a sostener decisiones de largo plazo. Pregúntate qué componente, actor o regla del negocio queda afectado. No me interesa que repitas la frase; me interesa que puedas señalar dónde aparece en el caso logístico.

La tercera conversación es sobre las consecuencias: La modularidad mejora la claridad y la evolución del sistema.. Aquí es donde una propuesta deja de ser teórica. Dime qué ganamos, qué sacrificamos y qué evidencia nos permitiría revisar la elección.

Finalmente, la fuente añade: La separación de responsabilidades reduce complejidad. Esta idea nos ayuda a completar el análisis y a evitar una solución parcial. Cuando terminemos, deberás poder relacionar este principio con una decisión concreta del proyecto.
...
## ❓ Preguntas para pensar en riesgos y supuestos en diseño
- **Te pregunto:** ¿Qué parte de mi sistema tiene responsabilidades mezcladas? **La razón:** así conectamos el tema con el problema real en lugar de aplicarlo por moda.
...
## 💡 Lo esencial sobre Riesgos y supuestos en diseño
...
- Un buen diseño facilita cambios sin romper el sistema completo.
- La arquitectura debe crear orden en medio de la complejidad.
...
### 🔎 Mi lectura de riesgos y supuestos en diseño como profesor
...
## 🏗️ Cómo resolver riesgos y supuestos en diseño en la práctica
Voy a resolver una situación contigo. La fuente plantea lo siguiente: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.

La idea central es que un sistema bien diseñado no solo funciona, sino que es más fácil de entender, mantener y evolucionar. Los principios de arquitectura sirven como brújula para tomar decisiones con criterio, especialmente cuando el proyecto crece en complejidad. Ahora llévalo a la plataforma logística: la plataforma logística debe recibir pedidos, asignar rutas y responder ante retrasos sin perder trazabilidad. Pregúntate qué parte del sistema conoce esa regla, qué información necesita y qué ocurriría si aumenta la carga, falla una dependencia o cambia la política del negocio.
...
## 🧩 Riesgos y supuestos en diseño: caso de la plataforma logística
...
## ✍️ Tu reto: aplicar riesgos y supuestos en diseño
...
- Confundir el nombre del tema con una explicación de cómo riesgos y supuestos en diseño afecta el sistema.
...
La fuente de este video plantea: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.
...
1. **Cuando te preguntes: ¿Qué parte de mi sistema tiene responsabilidades mezcladas?** Mi respuesta de partida sería: relaciona esta pregunta con la idea de que El diseño arquitectónico no es un detalle opcional. Después busca una evidencia en el caso, no una opinión.
2. **Cuando te preguntes: ¿Qué principio arquitectónico me está faltando aplicar?** Mi respuesta de partida sería: relaciona esta pregunta con la idea de que Los principios ayudan a sostener decisiones de largo plazo. Después busca una evidencia en el caso, no una opinión.
3. **Cuando te preguntes: ¿Estoy diseñando para la claridad o para la improvisación?** Mi respuesta de partida sería: relaciona esta pregunta con la idea de que La modularidad mejora la claridad y la evolución del sistema. Después busca una evidencia en el caso, no una opinión.
...
El tema de esta clase se concreta así: Este video presenta los fundamentos del diseño arquitectónico: cómo una solución técnica debe estructurarse para ser clara, sostenible y adaptable. La arquitectura no se basa solo en elegir herramientas, sino en aplicar principios que guíen la organización del sistema. Entre esos principios están la modularidad, la separación de responsabilidades, la reutilización con sentido y la reducción del acoplamiento.

La idea central es que un sistema bien diseñado no solo funciona, sino que es más fácil de entender, mantener y evolucionar. Los principios de arquitectura sirven como brújula para tomar decisiones con criterio, especialmente cuando el proyecto crece en complejidad. En el proyecto, el riesgo consiste en aplicar esa idea de forma superficial y terminar con una decisión que no protege el objetivo real. Por eso debemos establecer límites antes de implementar.
...
La alternativa A reduce el costo inicial y conserva simplicidad, pero puede dejar expuesto el riesgo principal de riesgos y supuestos en diseño. La alternativa B ofrece una protección más explícita, pero agrega trabajo, dependencias o complejidad operativa. No conviene elegir B solo porque suena más moderna; debe responder a la evidencia del caso.

### ✅ Paso 5. Tomar una decisión para el MVP
Para el MVP, recomiendo elegir la alternativa que proteja primero esta idea de la fuente: El diseño arquitectónico no es un detalle opcional.. Declara qué complejidad estás aceptando y qué señal te obligaría a cambiar la decisión.
