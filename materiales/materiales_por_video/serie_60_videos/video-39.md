...
- **Te pregunto:** ¿qué parte del problema pertenece realmente a domain driven design para arquitectura limpia? **La razón:** así evitamos aplicar el concepto donde no aporta valor.
