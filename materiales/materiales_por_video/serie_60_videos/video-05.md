...
- **Te pregunto:** ¿qué parte del problema pertenece realmente a requisitos funcionales y no funcionales? **La razón:** así evitamos aplicar el concepto donde no aporta valor.
