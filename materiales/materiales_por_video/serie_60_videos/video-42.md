...
- **Te pregunto:** ¿qué parte del problema pertenece realmente a métricas cuantitativas para evaluar arquitecturas? **La razón:** así evitamos aplicar el concepto donde no aporta valor.
