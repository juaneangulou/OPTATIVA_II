...
- **Te pregunto:** ¿qué parte del problema pertenece realmente a máquinas de estado finito en el front-end? **La razón:** así evitamos aplicar el concepto donde no aporta valor.
