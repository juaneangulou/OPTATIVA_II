...
- **Te pregunto:** ¿qué parte del problema pertenece realmente a fitness functions para medir arquitectura? **La razón:** así evitamos aplicar el concepto donde no aporta valor.
