...
La fuente consultada para esta clase es 'Video 19: Estructura de software y evolución del sistema'. En nuestro recorrido la conectamos con el tema 'Estructura del sistema y estilos arquitectónicos' porque queremos estudiar estructura del sistema y estilos arquitectónicos desde un problema real. La fuente plantea: Este video resalta la relación entre la estructura del software y su capacidad de evolución. Los sistemas no son estáticos; cambian con el tiempo, según la carga, el negocio, las reglas y las necesidades del usuario. Por eso, la arquitectura debe permitir cambios sin provocar caos. La estructura del software debe facilitar adaptaciones, no volverlas costosas o riesgosas.
...
## 🔀 Opciones para resolver estructura del sistema y estilos arquitectónicos
